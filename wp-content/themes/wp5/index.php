		...
		<div class="banner">
						...
						<li>
									<div class="banner-info">
										<h3>To enjoy the glow of good health, you must exercise. </h3>
									</div>
								</li>
							</ul>
						</div>
	 ...
	 <div class="container">
		 <div class="col-md-4 bride-grid">
			 <div class="content-grid l-grids">
				 <figure class="effect-bubba">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/b1.jpg" alt=""/>
						<figcaption>
							<h4>Cardio </h4>
			 ...
			 <div class="content-grid l-grids">
				 <figure class="effect-bubba">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/b2.jpg" alt=""/>
						<figcaption>
							<h4>Aerobics</h4>
							<p>In sit amet sapien eros Integer in tincidunt labore et dolore magna aliqua</p>																
						</figcaption>			
				 ...
				 <h3>Aerobics</h3>
		 		 ...
		 		 <div class="col-md-4 bride-grid">
				<div class="content-grid l-grids">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/brid.jpg" alt=""/>
		 ...
		 <div class="col-md-4 bride-grid">
			 <div class="content-grid l-grids spanl-grid1">
				 <figure class="effect-bubba">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/b3.jpg" alt=""/>
						<figcaption>
			 ...
			 <div class="content-grid l-grids spanl-grid2">
				 <figure class="effect-bubba">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/b4.jpg" alt=""/>
						<figcaption>
...
<div id="pricing" class="pricing">
	 <div class="container">
		 ...
		 <div class="pricing-section">
			 <div class="col-md-4 pricing-grid">
				 ...
				 <div class="pricing-offer">
					 <ul>
						<li class="whyt"><a href="#">Unlimited Monthly Sessions </a></li>
						<li><a href="#">8 Class Package</a></li>
						<li class="whyt"><a href="#">10 Class Package</a></li>
						<li><a href="#">4 Class Package </a></li>
						<li class="whyt"><a href="#">One Class Walk In</a></li>
				     </ul>
		 ...
		 <!--pop-up-grid-->
		 <script src="<?php echo get_stylesheet_directory_uri(); ?>/js/jquery.magnific-popup.js" type="text/javascript"></script>
				...
				<div class="team-left">
					<div class="col-md-3 team-top">
						<div class="view view-seventh">
								<a href="#"><img class="img-responsive" src="<?php echo get_stylesheet_directory_uri(); ?>/images/t1.jpg" alt=""></a>
					                 <div class="mask">
					...
					<div class="col-md-3 team-top team-in">
						<div class="view view-seventh">
								<a href="#"><img class="img-responsive" src="<?php echo get_stylesheet_directory_uri(); ?>/images/t2.jpg" alt=""></a>
								<div class="mask">
				 						<ul class="social-icons">
											<li><a href="#"><span class="facebook"> </span></a></li>
											<li><a href="#"><span class="twitter"> </span></a></li>
					...
					<div class="col-md-3 team-top">
						<div class="view view-seventh">
									<a href="#"><img class="img-responsive" src="<?php echo get_stylesheet_directory_uri(); ?>/images/t3.jpg" alt=""></a>
									<div class="mask">
				 						<ul class="social-icons">
											<li><a href="#"><span class="facebook"> </span></a></li>
											<li><a href="#"><span class="twitter"> </span></a></li>
					...
					<div class="col-md-3 team-top top-team">
						<div class="view view-seventh">
									<a href="#"><img class="img-responsive" src="<?php echo get_stylesheet_directory_uri(); ?>/images/t4.jpg" alt=""></a>
								<div class="mask">
				 						<ul class="social-icons">
											<li><a href="#"><span class="facebook"> </span></a></li>
											<li><a href="#"><span class="twitter"> </span></a></li>
